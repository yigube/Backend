...
import { registrarDesdeQR, resumenCurso, listarAusentesCurso } from '../controllers/asistencias.controller.js';
import { qrRules, resumenRules, ausentesRules } from '../middleware/validators.js';
...
router.get('/ausentes', authRequired, ausentesRules, handleValidation, asyncHandler(listarAusentesCurso));
